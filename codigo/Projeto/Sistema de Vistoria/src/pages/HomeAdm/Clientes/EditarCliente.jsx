...
function EditarCliente() {
  ...
  useEffect(() => {
    ...
    if (clienteEncontrado) {
      setFormData(clienteEncontrado); //preenchimento dos dados no formulario
    } else {
  ...
  const handleUpdate = (e) => {
    ...
    const updatedClientes = clientes.map(cliente =>
      cliente.id === parseInt(id) ? { 
        ...formData, 
        id: parseInt(id), //mantem o id do cliente original
        idCliente: parseInt(formData.idCliente) || parseInt(id) //aqui atualiza o idCliente
      } : cliente
    );
