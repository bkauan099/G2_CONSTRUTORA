...
function CriarRelatorioAI() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Corrige dataVistoria para timestamps com fuso -03:00 (Brasília)
        const data = new Date(form.dataVistoria + "T00:00:00-03:00");
        const payload = { ...form, dataVistoria: data.toISOString() };
        ...
        if (dataResp.arquivo) {
            navigate(`/vistoriador/vistoria/${form.idVistoria}`, {
                state: { relatorio: dataResp.arquivo },
            });
        } else {
