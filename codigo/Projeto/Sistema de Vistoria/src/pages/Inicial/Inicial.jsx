...
        <h2 className="bottom-info-title">O que você encontra <br /> na Civis Vistorias</h2>
        <div className="info-cards-container">
            ...
            <div id="servicos-section" className="info-card">
                <img src="/imagens/icon-servicos.png" alt="Ícone de Serviços" className="card-icon" />
            ...
            <div id="localizacao-section" className="info-card">
                <img src="/imagens/icon-localizacao.png" alt="Ícone de Localização" className="card-icon" />
                <h3>Localização</h3>
            ...
            <div id="contatos-section" className="info-card">
                <img src="/imagens/icon-contatos.png" alt="Ícone de Contato" className="card-icon" />
                <h3>Contatos</h3>
